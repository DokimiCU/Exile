...
local decoration_list = {
  ...
  { --[[ forest: vansano                         ]]    "fr_nn:vansano"                   , "simple"   , forest_on                          , nil,           80,     0.010000,  nil                                                                                                              ,     lowland_max,   coastal_max, "nodes_nature:vansano"             , nil          , nil,         nil                  , nil                             ,      nil,   2,   nil, },
	{ --[[ forest: merki                           ]]    "fr_nn:merki"                     , "simple"   , forest_on                          , nil,           16,     nil     ,  {offset =  0.00, scale = 0.0200, spread = {x =  32, y =  32, z =  32}, seed =   1112, octaves = 2, persist = 0.7},      upland_max,   lowland_max, "nodes_nature:merki"               , nil          , nil,         nil                  , nil                             ,      nil,   2,   nil, },
  ...
  { --[[ forest: zufani                          ]]    "fr_nn:zufani"                    , "simple"   , forest_on                          , nil,           80,     0.000500,  nil                                                                                                              ,      upland_max,     beach_max, "nodes_nature:zufani"              , nil          , nil,         nil                  , nil                             ,      nil,   2,   nil, },
  ...
  { --[[ woodland: damo                          ]]    "wl_nn:damo"                      , "simple"   , woodland_on                        , nil,           80,     0.030000,  nil                                                                                                              ,     lowland_max,     beach_max, "nodes_nature:damo"                , nil          , nil,         nil                  , nil                             ,      nil,   4,   nil, },
...
----Eggs
  ...
  { --[[   Animals: kubwakubwa forest            ]]    "animals:kubwakubwa_eggs_forest"  , "simple"   , forest_on                          , nil,           80,     0.000500,  nil                                                                                                              ,        upland_max,  coastal_max, "animals:kubwakubwa_eggs"         , nil          , nil,         nil                  , "all_floors"                    ,      nil, nil,   nil, },
