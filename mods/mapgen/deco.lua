...
local decoration_list = {
  ...
  { --[[ rich forest: damo                       ]]    "nodes_nature:damo"               , "simple"   , rich_forest_on                     , nil,           80,     0.800000,  nil                                                                                                              ,      lowland_max,    beach_max, "nodes_nature:damo"                , nil          , nil,         nil                  , nil                             ,      nil,   4,   nil, },
  ...
  { --[[ Trees: common panasee in forest         ]]    "panasee_forest"                  , "schematic", forest_on                          ,  -1,           80,     0.001000,  nil                                                                                                              ,      upland_max,     beach_max, nil                                , nil          , nil,         find("panasee")      , "place_center_x, place_center_z", "random", nil,   nil, },
  ...
  { --[[ forest Chalin                           ]]    "fr_nn:chalin"                    , "schematic", forest_on                          , nil,           80,     0.015000,  nil                                                                                                              ,      upland_max,     beach_max, nil                                , nil          , nil,         chalin               , nil                             ,      nil, nil,   nil, },
...
---- Wetlands
  { --[[ Marshland: cana                         ]]    "nodes_nature:cana"               , "schematic", marshland_on                       , nil,           16,     nil     ,  {offset =  0.00, scale = 3.0000, spread = {x =  16, y =  16, z =  16}, seed =    578, octaves = 3, persist = 0.7},     coastal_max,     beach_max, nil                                , nil          , nil,         cana                 , nil                             ,      nil, nil,   nil, },
  { --[[ Marshland: bronach                      ]]    "nodes_nature:bronach"            , "simple"   , marshland_on                       , nil,           16,     nil     ,  {offset =  0.00, scale = 0.0700, spread = {x =  16, y =  16, z =  16}, seed =   1707, octaves = 2, persist = 0.9},     coastal_max,     beach_max, "nodes_nature:bronach"             , nil          , nil,         nil                  , nil                             ,      nil,   3,   nil, },
  { --[[ wetland: tanai                          ]]    "nodes_nature:tanai"              , "simple"   , wetland_on                         , nil,           80,     0.900000,  nil                                                                                                              ,     coastal_max,     beach_max, "nodes_nature:tanai"               , nil          , nil,         nil                  , nil                             ,      nil,   4,   nil, },
  ...
  { --[[  wetland: denser moss in marsh          ]]    "wl_nn:moss"                      , "simple"   , wetland_on                         , nil,           16,     nil     ,  {offset =  0.00, scale = 0.3000, spread = {x =  16, y =  16, z =  16}, seed =   1640, octaves = 2, persist = 0.9},     coastal_max,     beach_max, "nodes_nature:moss"                , nil          , nil,         nil                  , nil                             ,      nil, nil,   nil, },
  ...
  { --[[ Shrubland: gitiri                       ]]    "sh_nn:gitiri"                    , "simple"   , shrubland_on                       , nil,           16,     nil     ,  {offset =  0.00, scale = 0.2000, spread = {x =  32, y =  32, z =  32}, seed =   1001, octaves = 2, persist = 0.6},      upland_max,     beach_max, "nodes_nature:gitiri"              , nil          , nil,         nil                  , nil                             ,      nil,   2,   nil, },
...
----Water
  { --[[Trees: kagum on salt silt                ]]    "nodes_nature:kagum_tree"         , "schematic", "nodes_nature:silt_wet_salty"      ,   0,           80,     nil     ,  {offset = 0, scale = 0.065, spread = {x = 128, y = 128, z = 128}, seed = 51122, octaves = 3, persist = 0.5}      ,                 1,           -1, nil                               , nil          , nil,         find("kagum1")       , "place_center_x, place_center_z", "random", nil,   nil, },
