...
local decoration_list = {
  ...
  { --[[ forest:   Momo                          ]]    "fr_nn:momo"                      , "simple"   , forest_on                          , nil,           80,     0.003000,  nil                                                                                                              ,    highland_max,   coastal_max, "nodes_nature:momo"                , nil          , nil,         nil                  , nil                             ,      nil,   1,   nil, },
  ...
  { --[[ woodland: hakimi                        ]]    "wl_nn:hakimi"                    , "simple"   , woodland_on                        , nil,           80,     0.001000,  nil                                                                                                              ,     lowland_max,     beach_max, "nodes_nature:hakimi"              , nil          , nil,         nil                  , nil                             ,      nil,   3,   nil, },
	{ --[[ woodland:   Momo                        ]]    "wl_nn:momo"                      , "simple"   , woodland_on                        , nil,           80,     0.001000,  nil                                                                                                              ,    highland_max,   coastal_max, "nodes_nature:momo"                , nil          , nil,         nil                  , nil                             ,      nil,   1,   nil, },
...
---- Wetlands
  ...
  { --[[ Shrubland: sari                         ]]    "sh_nn:sari"                      , "simple"   , shrubland_on                       , nil,           80,     0.150000,  nil                                                                                                              ,    highland_max,     beach_max, "nodes_nature:sari"                , nil          , nil,         nil                  , nil                             ,      nil,   2,   nil, },
