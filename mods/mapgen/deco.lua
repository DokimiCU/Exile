...
local decoration_list = {
	...
	{ --[[    Oceans: kelp                         ]]	"nodes_nature:kelp"                 ,	"simple"   ,	{"nodes_nature:gravel",	"nodes_nature:gravel_wet_salty"},	 -1,	 16,	nil     ,	{offset = -0.04, scale = 0.3000, spread = {x =  64, y =  64, z =  64}, seed =  82112, octaves = 3, persist = 0.8},	               -7,	         -15,	"force_placement",	"nodes_nature:kelp"             ,	nil          ,	nil,        	nil                                                              ,	nil,            	nil                             ,	     nil,	      48,	     96,	     },
	{ --[[    Oceans: seagrass                     ]]	"nodes_nature:seagrass"             ,	"simple"   ,	{"nodes_nature:sand"  ,	"nodes_nature:sand_wet_salty"}  ,	 -1,	 16,	nil     ,	{offset =  0.00, scale = 0.4000, spread = {x =  32, y =  32, z =  32}, seed =  11312, octaves = 3, persist = 0.8},	               -2,	          -5,	"force_placement",	"nodes_nature:seagrass"         ,	nil          ,	nil,        	nil                                                              ,	nil,            	nil                             ,	     nil,	      16,	    nil,	     },
	{ --[[    Oceans: sea lettuce                  ]]	"nodes_nature:sea_lettuce"          ,	"simple"   ,	{"nodes_nature:silt"  ,	"nodes_nature:silt_wet_salty"}  ,	 -1,	 16,	nil     ,	{offset =  0.00, scale = 0.4000, spread = {x =  32, y =  32, z =  32}, seed =  84322, octaves = 3, persist = 0.8},	               -2,	          -5,	"force_placement",	"nodes_nature:sea_lettuce"      ,	nil          ,	nil,        	nil                                                              ,	nil,            	nil                             ,	     nil,	      16,	    nil,	     },
	{ --[[     Trees: maraka in grassland          ]]	"nodes_nature:maraka_tree"          ,	"schematic",	grassland_on                                            ,	nil,	 16,	nil     ,	{offset =  0.00, scale = 0.0007, spread = {x = 250, y = 250, z = 250}, seed =    222, octaves = 3, persist = 0.7},	               22,	lowland_ymin,	              nil,	nil                             ,	nil          ,	nil,        	minetest.get_modpath("mapgen") .. "/schematics/maraka_tree.mts"  ,	 -3,            	"place_center_x, place_center_z",	"random",	     nil,	    nil,	     },
	{ --[[     Trees: maraka in woodland           ]]	"nodes_nature:maraka_tree2"         ,	"schematic",	woodland_on                                             ,	nil,	 80,	0.006000,	nil                                                                                                              ,	               40,	lowland_ymin,	              nil,	nil                             ,	nil          ,	nil,        	minetest.get_modpath("mapgen") .. "/schematics/maraka_tree.mts"  ,	 -3,            	"place_center_x, place_center_z",	"random",	     nil,	    nil,	     },
	{ --[[     Trees: old tangkal in woodland      ]]	"nodes_nature:tangkal_tree_old"     ,	"schematic",	woodland_on                                             ,	nil,	 80,	0.000900,	nil                                                                                                              ,	               25,	lowland_ymin,	              nil,	nil                             ,	nil          ,	nil,        	minetest.get_modpath("mapgen") .. "/schematics/tangkal_old.mts"  ,	 -5,            	"place_center_x, place_center_z",	"random",	     nil,	    nil,	     },
	{ --[[     Trees: adult tangkal in woodland    ]]	"nodes_nature:tangkal_tree"         ,	"schematic",	woodland_on                                             ,	nil,	 80,	0.000700,	nil                                                                                                              ,	               25,	lowland_ymin,	              nil,	nil                             ,	nil          ,	nil,        	minetest.get_modpath("mapgen") .. "/schematics/tangkal_tree.mts" ,	 -5,            	"place_center_x, place_center_z",	"random",	     nil,	    nil,	     },
	{ --[[     Trees: young tangkal in woodland    ]]	"nodes_nature:tangkal_tree_young"   ,	"schematic",	woodland_on                                             ,	nil,	 80,	0.000500,	nil                                                                                                              ,	               25,	lowland_ymin,	              nil,	nil                             ,	nil          ,	nil,        	minetest.get_modpath("mapgen") .. "/schematics/tangkal_young.mts",	 -3,            	"place_center_x, place_center_z",	"random",	     nil,	    nil,	     },
	{ --[[     Fills: Gravel Sediment              ]]	"nodes_nature:gravel"               ,	"simple"   ,	{"group:sand", "nodes_nature:silt"}                     ,	nil,	 04,	nil     ,	{offset = -0.80, scale = 2.0000, spread = {x = 100, y = 100, z = 100}, seed =  53995, octaves = 3, persist = 1.0},	                1,	          -1,	              nil,	"nodes_nature:gravel"           ,	"group:water",	  1,        	nil                                                              ,	 -1,            	"force_placement"               ,	     nil,	     nil,	    nil,	     },
